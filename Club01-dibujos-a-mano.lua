...
recorrido = {
        ...
        objetivo = "Marte",
        pistas = { 
            { texto = "Lucimar_1: Dijo que quería visitar un planeta que tenga cuatro estaciones como la tierra.", personaje = "Lucimar_01_dibujo.png" }
        },
        ...
        objetivo = "Venus",
        pistas = {
            { texto = "Lucimar_2: Siempre quizo conocer ese planeta tan brillante que solemos confundir con una estrella.", personaje = "Lucimar_02_dibujo.png" }
        },
        ...
        objetivo = "Sol",
        pistas = {
            { texto = "Thiago_1: Lo vimos dirigirse hacia esa enorme bola de gas caliente.", personaje = "Thiago_dibujo.png" },
            { texto = "Abigail: Se la pasó repitiendo esta adivinanza -Tengo corona pero no soy rey-.", personaje = "Abigail_01_dibujo.png" }
        },
        ...
        objetivo = "Dione",
        pistas = {
            { texto = "Juli: Quería conocer la luna interior más alejada de Saturno", personaje = "Juli_dibujo.png" }
        },
